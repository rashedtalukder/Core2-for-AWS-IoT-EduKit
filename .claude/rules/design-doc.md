...
[.claude/design.md](../design.md). It must stay accurate as the code changes.

## When this rule applies

Whenever you make a change that affects any of the following, you MUST review
[.claude/design.md](../design.md) in the same task and update it if it is now
stale:
...
2. Re-read the affected section(s) of [.claude/design.md](../design.md).
